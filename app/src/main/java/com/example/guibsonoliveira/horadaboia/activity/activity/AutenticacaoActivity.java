...
public class AutenticacaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipoAcesso.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                ...
                {
                    /*Deixa visível o Switch TipoUsuario*/
        ...
        botaoAcessar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!email.isEmpty())
                {
                    ...
                    if (!senha.isEmpty())
                    {
                        /*Verifica se é pra logar ou cadastrar*/
                            ...
                            ).addOnCompleteListener(new OnCompleteListener<AuthResult>()
                            {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task)
                                {
                                    if (task.isSuccessful())
                                    {
                                        ...
                                        /*Atualiza o tipo do usuario no firebase
                                        * E Empresa U usuario*/
                                        String tipoUsuario = getTipoUsuario();
                                        UsuarioFirebase.atualizaTipoUsuario(tipoUsuario);

                                        /*Abre a page home (Ou de usuario ou de empresa)*/
                                        abrirTelePrincipal(tipoUsuario);
                                    }else
                                    {
                                        String erroExcecao = "";
                                        try
    ...
    {
        /*Se tipo usuario estiver marcado retorna E de Empresa
        * se não retorna U de usuario*/
        return tipoUsuario.isChecked() ? "E" : "U";
    }

    private void abrirTelePrincipal(String tipoUsuario)
    {
